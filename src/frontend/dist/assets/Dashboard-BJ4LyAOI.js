import { c as createLucideIcon, k as commonjsGlobal, l as getDefaultExportFromCjs, r as reactExports, m as clsx, R as React, n as invariant, j as jsxRuntimeExports, B as Button, d as Badge, U as Users, o as cn, p as Bell, A as Avatar, q as AvatarFallback, s as SquareCheckBig, t as useNotificationStore, D as Dialog, v as DialogContent, w as DialogHeader, x as DialogTitle, i as Label$1, T as Textarea, y as DialogFooter, z as Send } from "./index-C4CKXjXp.js";
...
import { D as Download, a as DollarSign } from "./download-r5-hAPbN.js";
import { T as TrendingUp, C as Clock } from "./trending-up-Bcd0qdYK.js";
...
import { P as Pin, M as Megaphone } from "./pin-C3JtHXj6.js";
...
const revenueChartData = [
  { label: "Jan", revenue: 98e3, target: 9e4 },
  { label: "Feb", revenue: 105e3, target: 95e3 },
  { label: "Mar", revenue: 112e3, target: 1e5 },
  { label: "Apr", revenue: 108e3, target: 105e3 },
  { label: "May", revenue: 124e3, target: 11e4 },
  { label: "Jun", revenue: 131e3, target: 115e3 },
  { label: "Jul", revenue: 129e3, target: 12e4 },
  { label: "Aug", revenue: 136e3, target: 125e3 },
  { label: "Sep", revenue: 141e3, target: 13e4 },
  { label: "Oct", revenue: 148200, target: 135e3 }
];
...
const dashboardAlerts = [
  {
    ...
    description: "Team velocity in the current sprint is below target. Consider re-prioritizing backlog.",
  ...
  },
  {
    ...
    description: "Tasks on the Payments API, Auth redesign, and Data pipeline are past their due dates.",
  ...
  },
  {
    ...
    description: "Q2 all-hands review is scheduled for April 18th. Prepare your team updates.",
...
const recentUpdates = [
  {
    ...
    content: "The new Payments API is live with 40% lower latency and full Stripe webhook support.",
    authorId: "member-1",
  ...
  },
  {
    ...
    content: "We're heading to Austin for a 3-day offsite focused on Q3 planning and team building.",
    authorId: "user-1",
  ...
  },
  {
    ...
    content: "Scheduled maintenance for the primary DB at 2am UTC. Expect ~15 min downtime.",
    authorId: "member-3",
...
const bottlenecks = [
  {
    ...
    description: "Security audit is blocking 3 downstream tasks from proceeding."
  },
  {
    id: "bt-2",
    ...
    description: "ETL migration is significantly delayed due to schema conflicts."
  },
  {
    id: "bt-3",
...
const KPI_ICONS = {
  DollarSign: /* @__PURE__ */ jsxRuntimeExports.jsx(DollarSign, { size: 16 }),
  Users: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 16 }),
  CheckSquare: /* @__PURE__ */ jsxRuntimeExports.jsx(SquareCheckBig, { size: 16 }),
  Clock: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 16 })
};
function ChartTooltip({ active, payload, label }) {
  if (!active || !(payload == null ? void 0 : payload.length)) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-popover text-popover-foreground border border-border shadow-lg rounded-lg px-3 py-2.5 text-xs min-w-[130px]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold mb-1.5 text-foreground text-[11px] uppercase tracking-wide", children: label }),
    payload.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 py-0.5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "capitalize text-muted-foreground", children: entry.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold ml-auto pl-2 tabular-nums", children: typeof entry.value === "number" && entry.value > 999 ? entry.value.toLocaleString() : entry.value })
    ] }, entry.name))
  ] });
}
...
const UPDATE_TYPE_ICONS = {
  milestone: /* @__PURE__ */ jsxRuntimeExports.jsx(SquareCheckBig, { size: 14, className: "text-success" }),
  announcement: /* @__PURE__ */ jsxRuntimeExports.jsx(Megaphone, { size: 14, className: "text-primary" }),
  alert: /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { size: 14, className: "text-warning" }),
  update: /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { size: 14, className: "text-info" })
};
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-semibold text-muted-foreground uppercase tracking-widest", children: "Growth Score" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 px-1.5 py-0.5 rounded bg-success/10 text-success text-[11px] font-semibold", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl sm:text-5xl font-bold text-foreground leading-none tabular-nums tracking-tight", children: growthScore.score }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground pb-1 font-medium", children: "/ 100" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2.5", children: growthScore.breakdown.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground font-medium", children: item.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-bold text-foreground tabular-nums", children: item.value })
          ] }),
...
function SendNotificationDialog({ open, onClose }) {
  const addNotification = useNotificationStore((s2) => s2.addNotification);
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 py-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "notif-message", className: "text-sm", children: "Message" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
                id: "notif-message",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "notif-type", className: "text-sm", children: "Type" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                value: type,
                onValueChange: (v2) => setType(v2),
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "notif-type", "data-ocid": "notif-type-select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: ["info", "warning", "error", "success"].map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: t2, children: typeLabels[t2] }, t2)) })
                ]
              }
            )
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { size: 14, className: "mr-1.5" }),
                "Send"
              ]
            }
          )
...
function formatTime(iso) {
  ...
  const diffMs = now2.getTime() - d2.getTime();
...
function Dashboard() {
  const [notifDialogOpen, setNotifDialogOpen] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "aria-label": "Key Performance Indicators", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-2 sm:col-span-2 lg:col-span-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GrowthScoreCard, {}) }),
          kpiMetrics.map((kpi) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              label: kpi.label,
              value: kpi.value,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "aria-label": "Analytics Charts", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl shadow-xs hover:shadow-sm transition-shadow duration-200 overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 sm:px-5 py-3 sm:py-3.5 border-b border-border/80", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { size: 12, className: "text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Revenue Over Time" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 sm:p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 240, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              LineChart,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl shadow-xs hover:shadow-sm transition-shadow duration-200 overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 sm:px-5 py-3 sm:py-3.5 border-b border-border/80", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 12, className: "text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "User Growth" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    YAxis,
                    {
                      ...
                      axisLine: false,
                      tickLine: false,
                      tickFormatter: (v2) => v2 >= 1e3 ? `${(v2 / 1e3).toFixed(1)}k` : String(v2),
                      width: 40
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartTooltip, {}) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "aria-label": "Operational Overview", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 sm:px-5 py-3 sm:py-3.5 border-b border-border/80", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Alerts" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center justify-center w-4 h-4 rounded-full bg-destructive/10 text-destructive text-[10px] font-bold", children: dashboardAlerts.length })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground", children: "Active" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col divide-y divide-border", children: dashboardAlerts.map((alert) => {
                      ...
                      "li",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground leading-snug", children: alert.title }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5 leading-relaxed line-clamp-2", children: alert.description })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground flex-shrink-0 mt-0.5 tabular-nums whitespace-nowrap", children: formatTime(alert.timestamp) })
                        ]
                      },
                      alert.id
                    );
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 sm:px-5 py-3 sm:py-3.5 border-b border-border/80", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Recent Updates" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Button,
                      {
                        type: "button",
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { size: 12, className: "mr-1" }),
                          "Notify"
                        ]
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col divide-y divide-border", children: recentUpdates.map((update) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "li",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-muted flex items-center justify-center flex-shrink-0 mt-0.5", children: UPDATE_TYPE_ICONS[update.type] ?? /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { size: 14, className: "text-info" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-0.5", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground truncate", children: update.title }),
                            update.pinned && /* @__PURE__ */ jsxRuntimeExports.jsx(
                              Pin,
                              {
                                size: 11,
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground line-clamp-2 leading-relaxed", children: update.content }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-1.5 flex-wrap", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-medium text-muted-foreground", children: update.authorName }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground/60", children: "·" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground", children: formatTime(update.createdAt) }),
                            update.reactions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1.5 ml-auto", children: update.reactions.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "span",
                              {
                                className: "inline-flex items-center gap-0.5 text-[11px] px-1 py-0.5 rounded bg-muted text-muted-foreground",
                                children: [
                                  r.emoji,
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tabular-nums", children: r.count })
                                ]
                              },
                              r.emoji
                            )) })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 sm:px-5 py-3 sm:py-3.5 border-b border-border/80", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Top Performers" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { size: 14, className: "text-warning" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col divide-y divide-border", children: topPerformers.map((performer, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "li",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(RankBadge, { rank: idx + 1 }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "w-7 h-7 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "text-[10px] bg-primary/10 text-primary font-bold", children: performer.memberName.split(" ").map((n2) => n2[0]).join("") }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground truncate", children: performer.memberName }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: performer.department })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end gap-1.5 flex-shrink-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-foreground tabular-nums", children: performer.score }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground tabular-nums", children: "pts" })
                          ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 sm:px-5 py-3 sm:py-3.5 border-b border-border/80", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Bottlenecks" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center justify-center w-4 h-4 rounded-full bg-warning/10 text-warning text-[10px] font-bold", children: bottlenecks.length })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 13, className: "text-warning" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col divide-y divide-border", children: bottlenecks.map((bt) => {
                      ...
                      "li",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2 mb-1", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground leading-snug flex-1 min-w-0", children: bt.title }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "span",
                              {
                                className: cn(
                                ...
                                children: bt.severity.charAt(0).toUpperCase() + bt.severity.slice(1)
                              }
                            )
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed line-clamp-2", children: bt.description }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1.5", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              StatusBadge,
                              {
                                status: bt.type === "blocked-task" ? "blocked" : bt.type === "overdue" ? "at-risk" : "in-progress"
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground truncate", children: bt.affectedItem })
                          ] })
                        ]
                      },
                      bt.id
