import { c as createLucideIcon, j as jsxRuntimeExports, o as cn, r as reactExports, O as useDirection, C as useControllableState, aa as Root2$1, E as useId, J as useComposedRefs, ab as Anchor, P as Primitive, F as composeEventHandlers, K as useLayoutEffect2, ac as Portal$1, ad as reactDomExports, ae as createPopperScope, N as createCollection, af as VISUALLY_HIDDEN_STYLES, ag as useCallbackRef, ah as hideOthers, ai as useFocusGuards, aj as ReactRemoveScroll, ak as FocusScope, al as DismissableLayer, H as createContextScope, am as createSlot, an as Content, ao as clamp, ap as Arrow, aq as Check } from "./index-C4CKXjXp.js";
/**
...
function PageHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex flex-col gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl sm:text-2xl font-bold text-foreground leading-tight tracking-tight", children: title }),
          subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed font-normal max-w-xl", children: subtitle })
        ] }),
        action && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center gap-2 flex-shrink-0 pt-0.5", children: action })
      ]
    }
  );
}
